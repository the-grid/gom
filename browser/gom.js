(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.GOM = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
var slice = [].slice;
...
module.exports = function(hooks) {
  ...
  $ = function() {
    ...
    tag = arguments[0], attributes = arguments[1], children = arguments[2], rest = 4 <= arguments.length ? slice.call(arguments, 3) : [];
    hook = hooks[tag];
    if (hook) {
      return hook.apply($, [attributes, children].concat(slice.call(rest)));
    }
...
},{"./mixins/helpers":2,"./mixins/render":3,"./mixins/transform":4}],2:[function(require,module,exports){
var clone,
...
module.exports = function($) {
  var _addClass, _hasClass, _removeClass, isNode;
  ...
  $.getChildren = function(node, childTagNames, classNames, isChild) {
    var c, child, childResult, foundChild, j, k, len, len1, matches, ref, ref1, ref2;
    if (isChild == null) {
      isChild = false;
    }
    if (!(childTagNames || classNames)) {
      return null;
    }
    foundChild = [];
    if (isChild) {
      matches = false;
      if (childTagNames) {
        if (ref = node != null ? node.tag : void 0, indexOf.call(childTagNames, ref) >= 0) {
          matches = true;
        }
      } else {
        matches = true;
      }
      if (matches && classNames) {
        if (((ref1 = node.attributes) != null ? ref1["class"] : void 0) != null) {
          matches = true;
          for (j = 0, len = classNames.length; j < len; j++) {
            c = classNames[j];
            if (node.attributes["class"].indexOf(c) === -1) {
              matches = false;
              break;
            }
          }
  ...
  $.getAttribute = function(node, key) {
    var ref;
    return node != null ? (ref = node.attributes) != null ? ref[key] : void 0 : void 0;
  };
  $.mergeAttributes = function(attributes1, attributes2, exclusions, concatString) {
    ...
    for (key in attributes1) {
      val = attributes1[key];
      if (indexOf.call(exclusions, key) < 0) {
        attributes[key] = val;
      }
    }
...
module.exports = function($) {
  var _render, _renderAttr, _renderChildren, _renderStyles, emptyTags, notAttr, render;
...
module.exports = function($) {
  var _transform, _transformNode, _transformNodes, transform;
  $.transform = transform = function() {
    var args, nodes, transforms;
    nodes = arguments[0], transforms = arguments[1], args = 3 <= arguments.length ? slice.call(arguments, 2) : [];
  ...
  _transformNodes = function(nodes, transforms, args) {
    var i, len, newNode, newNodes, node;
    newNodes = [];
    for (i = 0, len = nodes.length; i < len; i++) {
      node = nodes[i];
  ...
  _transformNode = function(node, transforms, args) {
    var callback, i, len, selector, t;
    args = (args != null ? args.slice() : void 0) || [args];
    if (!args.length) {
      args.push(null);
    }
    args.unshift(node);
